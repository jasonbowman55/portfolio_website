...
export default function Lab2Page() {
  return (
    <div className="mx-auto max-w-[100rem] px-4 py-16">
      ...
      <p className="eyebrow mb-4">Lab 2 · E80</p>
      <h1 className="font-display text-4xl font-semibold text-ink md:text-5xl">BEM</h1>
      <p className="mt-4 text-lg text-body">
        Boundary Element Method for hydrodynamic analysis and vehicle modeling.
      </p>
      ...
      <div className="blueprint-frame mt-10 max-w-md overflow-hidden rounded-lg border border-line">
        <img src="/images/underwater/lab2.jpeg" alt="Lab 2: BEM" className="w-full" />
      </div>
      ...
      <LinkPreview
        href="https://drive.google.com/file/d/1jr20M69VYiIHlnWu445LXzpf1TrMCuFO/view?usp=sharing"
