...
export default function Lab6Page() {
  return (
    <div className="mx-auto max-w-[100rem] px-4 py-16">
      ...
      <p className="eyebrow mb-4">Lab 6 · E80</p>
      <h1 className="font-display text-4xl font-semibold text-ink md:text-5xl">
        Fluid Dynamics Technical Memorandum
      </h1>
      <p className="mt-4 text-lg text-body">
        Fluid dynamics analysis and hydrodynamic optimization.
      </p>
      ...
      <div className="blueprint-frame mt-10 max-w-md overflow-hidden rounded-lg border border-line">
        <img
          src="/images/underwater/lab6.jpeg"
          alt="Lab 6: Fluid Dynamics Technical Memorandum"
          className="w-full"
        />
      </div>
      ...
      <LinkPreview
        href="https://drive.google.com/file/d/1khie_yhsyVY0-u7opmbmVQnYqpIBjSet/view?usp=sharing"
