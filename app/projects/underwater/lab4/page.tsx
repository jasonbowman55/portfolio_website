...
export default function Lab4Page() {
  return (
    <div className="mx-auto max-w-[100rem] px-4 py-16">
      ...
      <p className="eyebrow mb-4">Lab 4 · E80</p>
      <h1 className="font-display text-4xl font-semibold text-ink md:text-5xl">Temperature</h1>
      <p className="mt-4 text-lg text-body">
        Integrating temperature sensors for environmental monitoring and compensation.
      </p>
      ...
      <div className="blueprint-frame mt-10 max-w-md overflow-hidden rounded-lg border border-line">
        <img src="/images/underwater/lab4.jpeg" alt="Lab 4: Temperature" className="w-full" />
      </div>
      ...
      <LinkPreview
        href="https://drive.google.com/file/d/1wmHXs_jkDRqvBVebrnnaE1i3WHQgXmyQ/view?usp=sharing"
